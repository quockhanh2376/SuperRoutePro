...
mod tests {
    use super::{
        collect_process_output, command_result_from_outputs, connectivity_probe_body_matches,
        connectivity_probe_status_matches,
        contains_disallowed_shell_metacharacters, normalize_dhcp_timeout_error,
        validate_network_command, ConnectivityProbeKind,
    };
